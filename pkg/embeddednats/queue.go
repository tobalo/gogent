...
func NewMessageQueue(cfg QueueConfig, processor BatchProcessor) *MessageQueue {
	return &MessageQueue{
		config:    cfg,
		processor: processor,
...
// SetProcessor sets the batch processor
func (q *MessageQueue) SetProcessor(processor BatchProcessor) {
